...
export const MovieScalarFieldEnumSchema = z.enum(['id','title','releaseDate','rating','options','createdAt','updatedAt','directorId']);

export const ShowScalarFieldEnumSchema = z.enum(['id','title','releaseDate','rating','options','createdAt','updatedAt','directorId']);
